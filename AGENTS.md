...
This project is indexed by GitNexus as **RAGChat** (3138 symbols, 5133 relationships, 168 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
