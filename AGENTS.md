...
This project is indexed by GitNexus as **RAGChat** (3978 symbols, 8077 relationships, 285 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
