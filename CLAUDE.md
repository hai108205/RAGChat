...
This project is indexed by GitNexus as **RAGChat** (3344 symbols, 5795 relationships, 214 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
