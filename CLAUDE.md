...
This project is indexed by GitNexus as **RAGChat** (3968 symbols, 7300 relationships, 260 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
