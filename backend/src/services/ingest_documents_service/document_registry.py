...
Tracks document_id, version_hash, and chunk_ids so the ingestion pipeline
can compute incremental diffs (new / changed / deleted).
"""
...
class DocumentRegistry:
    ...
    pipeline can compute incremental diffs.
    """
